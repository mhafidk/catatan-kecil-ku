...
>
  <a href="/post/{post.slug}" class="flex flex-col gap-3 flex-1">
    ...
    <div class="flex items-start justify-between gap-4">
      <h2
        class="text-lg font-bold tracking-tight text-zinc-100 group-hover:text-lime-400 transition-colors duration-300"
      >
        {post.title}
      </h2>
      <div
        class="p-1.5 rounded-full bg-zinc-900/60 border border-zinc-800/50 text-zinc-400 group-hover:text-lime-400 group-hover:border-lime-500/20 group-hover:bg-lime-950/20 transition-all duration-300 shrink-0"
      >
        <ArrowRight
